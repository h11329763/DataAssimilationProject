...
E_Err_e2 = np.nanmean(Err_e2[ss_:300])
...
ax.set_title('RMSE in Steady State - OI', fontsize = 22.)
ax.set_xticks(x)
...
# fig.tight_layout()
plt.savefig('RMSE_comp_OI_1221.eps', format='eps', bbox_inches = "tight")

#plt.savefig('RMSE_comp_OI_1221.png', dpi = 200, bbox_inches = 'tight')
plt.show()
