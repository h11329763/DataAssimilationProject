...
np.savetxt('x_a_enkf_e2_0.1_1221_NoR_%dn.txt'%(members), np.nanmean(x_ak_save, axis = -1))

'''
np.savetxt('x_a_enkf_e2_0.1_1221_%dR_%dn.txt'%(R,members), np.nanmean(x_ak_save, axis = -1))
#'''